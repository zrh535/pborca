// ***********************************************************
// Copyright (c) 1991 - 2008 Sybase, Inc.
// All rights reserved. All unpublished rights reserved.
//
//   Filename:  pborca.h
//
//   Purpose:   PowerBuilder ORCA public header file
//              Include this header file after <windows.h>
// **********************************************************
...
/* ************************************************************************* */
/* Structure for PBORCA_BuildWinFormProject/PBORCA_BuildWebFormProject callback function.*/
/* ************************************************************************* */
...
/* ************************************************************************* */
/* Prototype for PBORCA_BuildWinFormProject/PBORCA_WebFormBuildProject callback function */
/* ************************************************************************* */
typedef PBCALLBACK(void, *PBORCA_DOTNETPROC) ( PPBORCA_DOTNET_MESSAGE, LPVOID );
...
PBWINAPI_(INT) PBORCA_SetDebug				( HPBORCA	hORCASession,
											  BOOL		bDebug );
...
PBWINAPI_(INT) PBORCA_BuildProjectWithOverrides       ( HPBORCA        hORCASession,
                                             LPTSTR         lpszLibraryName,        
                                             LPTSTR         lpszProjectName,
	                                         PBORCA_BLDPROC pBuildErrProc,
											 LPTSTR			lpszServerName,
...
PBWINAPI_(INT) PBORCA_DeployWinFormProject  ( HPBORCA        hORCASession,
                                             LPTSTR         lpszLibraryName,        
                                             LPTSTR         lpszProjectName,
                                             LPTSTR         lpszIconFile,
...
typedef INT     (WINAPI *FP_BuildProjectWithOverrides)
		( HPBORCA, LPTSTR, LPTSTR, PBORCA_BLDPROC, LPTSTR, INT, LPTSTR, LPTSTR, LPVOID );
...
typedef INT     (WINAPI *FP_DeployWinFormProject)
		( HPBORCA, LPTSTR, LPTSTR, LPTSTR, PBORCA_DOTNETPROC, LPVOID );
